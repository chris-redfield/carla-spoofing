...
from .remove_object import RemoveObjectAttack, RemoveObjectsAttack, RemoveTarget
...
ATTACKS = {
    ...
    "remove_objects": RemoveObjectsAttack,
...
__all__ = [
    ...
    "RemoveObjectAttack", "RemoveObjectsAttack", "RemoveTarget",
